 // When the window has finished loading create our google map below
      ...
      center: new google.maps.LatLng(59.912202, 30.330709),
      ...
      [
        new google.maps.Marker({
          ...
          position: new google.maps.LatLng(59.911486, 30.330055),
          map: map,
          icon: mapimage
        })
      ];
      ...
      infoBubble = new InfoBubble({
        ...
        closeSrc: '/../img/blank.png'
      });
      
      // Clicks
      function open_bubble1(){
        infoBubble.setContent('<img class="avatar" src="/../img/map_avatar.png"><p>Санкт-Петербург / наб. Обводного канала <br>д.<span class="blue">60</span> БЦ Ткачи офис <span class="blue">310</span>, индекс <span class="blue">192007</span></p>');
