...
function animateScroll(e)
{
    ...
    if (scrollData < 0 && $('.screen-1').hasClass('active'))
    {
        ...
        tlForm
                ...
                .to( $('.model img'), .6, {y: 140, ease: Power3.easeIn})
                .to( $parallaxBase, .6, {y: 140, ease: Power3.easeIn}, '-=.6')
        ...
        tlForm
                ...
                .set( $obj, {y: '0%'})
                .to( $('.model img'), .6, {y: 0, ease: Power4.easeOut})
                .to( $parallaxBase, .6, {y: 0, ease: Power4.easeOut}, '-=.6')
...
$(window).on('load', function()
{
    ...
    tlLoader
        ...
        .staggerTo( $parallaxSecond, 1.3, {y: 0, autoAlpha: 1, ease: Power4.easeOut}, 0.05, '-=.8');
